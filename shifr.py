"""
Данный текст программы "Квадратный шифр v.1.4. принадлежит Василию Дюгурову
и защищен Свидетельством о государственной регистрации программы для ЭВМ
№2024682366  от 23.09.2024
"""
